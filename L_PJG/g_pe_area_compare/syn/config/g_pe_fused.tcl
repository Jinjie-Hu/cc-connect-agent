# g_pe_fused - G_PE before/after area comparison (logic mode, single TT corner)
...
set my_toplevel G_PE_fused
set flist       /home/asic03/graduate/proj_hujinjie/g_pe_area_test/syn/script/g_pe_fused/G_PE_fused.filelist
