...
module complex_negative #(
	...
	assign InputA_r  = InputA[INPUT_BIT_WIDTH-1:INPUT_BIT_WIDTH_HALF];
	assign InputA_i  = InputA[INPUT_BIT_WIDTH_HALF-1:0];
	assign OutputB_r = ~InputA_r + 1'b1;
