...
module G_PE(H_in, H_conj_in, H_out, H_conj_out, clk, rst_n, G_reg_rst, G_out, G_in, G_out_EN, G_store_EN, G_clk_En);
	...
	assign G_out_new[1] = G_out_EN ? G_in[1] : 
					      G_store_EN ? `COMPLEX_VALUE_TRANSFER(mac_out, G_ACC_FULL_QTZ, G_QTZ) : 'b0;
