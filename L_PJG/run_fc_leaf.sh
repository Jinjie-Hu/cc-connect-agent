#!/bin/bash
# FC re-run: fused whole-design L_PJG vs leaf-semantics golden
# golden: L_PJG/rtl/data/128x32_c5_fused/x_p8.txt  md5 1ab823c11b440f3dcd0f16fe9f339b78
...
echo "=== compiling fused whole-design FC (leaf golden) ==="
