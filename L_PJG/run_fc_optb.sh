#!/bin/bash
# FC re-run: fused whole-design L_PJG (Option B widened accumulators) vs gauss
# golden = single-truncation sites 1&2 + Gauss-per-leaf site 3.
# golden: L_PJG/rtl/data/128x32_c5_fused_optb/x_p8.txt  md5 29cdbe71a026bb7f7cdd18620f1f585d
...
echo "=== compiling fused whole-design FC (Option B vs gauss golden) ==="
/eda/synopsys/vcs/VCS/VCS2014/bin/vcs -sverilog +v2k -timescale=1ns/1ns \
  ...
  +define+FC_DATA_DIR=\"/home/asic03/graduate/proj_hujinjie/L_PJG/rtl/data/128x32_c5_fused_optb\" \
  +define+FC_DUMP_XO \
